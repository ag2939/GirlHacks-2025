...
public class EVSPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_evspage);
    ...
    private void init(Bundle savedInstanceState) {
        ...
        videoType = fromMainMenu.getStringExtra("videoTypeFromMainMenuToEVSPage");
        subject = fromMainMenu.getStringExtra("subjectNameFromMainMenuToEVSPage");
        userDetails = fromMainMenu.getStringArrayExtra("UserDetailsFromMainMenuToEVSPage");
    ...
    private void createVideosList(Bundle savedInstanceState) {
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                RecyclerView recyclerView = findViewById(R.id.recyclerViewEVS);
